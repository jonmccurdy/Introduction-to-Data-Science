...
::: learning-goals
-   Explain the relationship between populations and samples in statistical inference.
-   Describe how the Law of Large Numbers connects to sampling variability.
-   Differentiate between a sample distribution and a sampling distribution.
-   Interpret how sample size affects the mean and standard deviation of a sampling distribution.
-   State and explain the Central Limit Theorem and its importance in data science.
:::

::: callout-tip
## Supplemental Material

<a href="Reading-Guide/L12-Reading-Guide.pdf" download> 📄 Download the lecture's Reading Guide </a>
:::
...
<div class="chapter-resources-header">
  <a href="https://youtu.be/D8FGIYkidEg" target="_blank">Lecture Video</a>
</div>

<div class="chapter-resources-grid">
  <div><a href="Assignments/Data-200-L12-Inclass-Assignment.pdf" target="_blank">In-Class Exercises</a></div>
  <div><a href="https://youtu.be/Cq2kFBm7Q54" target="_blank">In-Class Exercises Video Solutions</a></div>
</div>

<div class="chapter-resources-footer lab-row">
  <a href="Assignments/Data-200-L12-Lab.pdf" target="_blank">Lab Problems</a>
</div>

<div class="chapter-resources-footer problem-set-row">
  <a href="Assignments/Data-200-L12-Problem-Set.pdf" target="_blank">Problem Set Questions</a>
</div>
