...
<a href="Reading-Guide/L2-Reading-Guide.pdf" download> 📄 Download the lecture's Reading Guide </a>
:::
...
<div class="chapter-resources-header">
  <a href="https://youtu.be/0z47_70IYtg" target="_blank">Lecture Video</a>
</div>

<div class="chapter-resources-grid">
  <div><a href="Assignments/Data-200-L2-Inclass-Assignment.pdf" target="_blank">In-Class Exercises</a></div>
  <div><a href="https://youtu.be/Ok56nlkQcVY" target="_blank">In-Class Exercises Video Solutions</a></div>
</div>

<div class="chapter-resources-footer lab-row">
  <a href="Assignments/Data-200-L2-Lab.pdf" target="_blank">Lab Problems</a>
</div>

<div class="chapter-resources-footer problem-set-row">
  <a href="Assignments/Data-200-L2-Problem-Set.pdf" target="_blank">Problem Set Questions</a>
</div>
...
<!-- 3)  Find the mean, median, and mode for the following quiz grades: $$ 84,\ 91,\ 87,\ 84,\ 88,\ 93,\ 84$$ -->

<!-- 4)  Calculate the standard deviation and range for the following steptotals (in thousands): $$9,\ 11,\ 7,\ 13,\ 10,\ 16$$ -->
...
<!-- 6)  Create a histogram using bin widths of 5 minutes (0-4.99, 5-9.99, etc.) $$3,\ 4,\ 5,\ 5,\ 6,\ 6,\ 7,\ 7,\ 7,\ 8,\ 8,\ 8,\ 8,\ 9,\ 9,\ 10,\ 10,\ 12,\ 15,\ 19$$ -->
