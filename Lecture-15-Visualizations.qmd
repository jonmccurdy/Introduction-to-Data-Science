...
One of the most important parts of data science is learning how to communicate what we see in data. While summary statistics can give us helpful numbers, visualizations allow us to notice patterns, trends, outliers, and relationships that might be difficult to see from numbers alone. In this lecture, we will look at different ways to visualize quantitative and qualitative variables using base R graphics. These visualizations will help us better understand datasets before making conclusions or running more advanced analyses.

::: learning-goals
-   Identify which visualizations are appropriate for quantitative variables and which are appropriate for qualitative variables.
-   Create and interpret common quantitative visualizations such as dot plots, histograms, density plots, boxplots, and QQ plots.
-   Create and interpret common qualitative visualizations such as frequency tables, pie charts, barplots, and Pareto charts.
-   Use R arguments such as `main`, `xlab`, `ylab`, `col`, `border`, `breaks`, annd `freq` to improve graph readability.
:::

::: callout-tip
## Supplemental Material

<a href="Reading-Guide/L15-Reading-Guide.pdf" download> 📄 Download the lecture's Reading Guide </a>
:::
...
<div class="chapter-resources-header">
  <a href="https://youtu.be/piPfY4lBecQ" target="_blank">Lecture Video</a>
</div>

<div class="chapter-resources-grid">
  <div><a href="Assignments/Data-200-L15-Inclass-Assignment.pdf" target="_blank">In-Class Exercises</a></div>
  <div><a href="https://youtu.be/Zj0Qjf7whFg" target="_blank">In-Class Exercises Video Solutions</a></div>
</div>

<div class="chapter-resources-footer lab-row">
  <a href="Assignments/Data-200-L15-Lab.pdf" target="_blank">Lab Problems</a>
</div>

<div class="chapter-resources-footer problem-set-row">
  <a href="Assignments/Data-200-L15-Problem-Set.pdf" target="_blank">Problem Set Questions</a>
</div>
