...
<a href="Reading-Guide/L7-Reading-Guide.pdf" download> 📄 Download the lecture's Reading Guide </a>
:::
...
role <- c("attendee", "speaker", "organizer", "attendee", "attendee", "organizer")
...
{{< video https://www.youtube.com/embed/j0H832hEQgg?modestbranding=1&rel=0 >}}
...
{{< video https://www.youtube.com/embed/gjFR0_Kcfpc?modestbranding=1&rel=0 >}}
...
{{< video https://www.youtube.com/embed/l2OJlmbU4BI?modestbranding=1&rel=0 >}}
...
{{< video https://www.youtube.com/embed/laW-yjj2IXg?modestbranding=1&rel=0 >}}
...
{{< video https://www.youtube.com/embed/laJvXNU7bJc?modestbranding=1&rel=0 >}}
...
{{< video https://www.youtube.com/embed/0DWMHEJzZmE?modestbranding=1&rel=0 >}}
...
<div class="chapter-resources-header">
  <a href="https://youtu.be/4Da_KgvcpWo" target="_blank">Lecture Video</a>
</div>

<div class="chapter-resources-grid">
  <div><a href="Assignments/Data-200-L7-Inclass-Assignment.pdf" target="_blank">In-Class Exercises</a></div>
  <div><a href="https://youtu.be/LfxDU7bCm_o" target="_blank">In-Class Exercises Video Solutions</a></div>
</div>

<div class="chapter-resources-footer lab-row">
  <a href="Assignments/Data-200-L7-Lab.pdf" target="_blank">Lab Problems</a>
</div>

<div class="chapter-resources-footer problem-set-row">
  <a href="Assignments/Data-200-L7-Problem-Set.pdf" target="_blank">Problem Set Questions</a>
</div>
...
<!--     c)  A logicial vector based on if it is a coastal state (only Pennsylvania is not on the coast) -->
<!--     d)  Display all of the coastal states -->
<!--     e)  Display all of the rows where the median income is greater than 80000 -->
<!--     f)  Display all of the rows where the state ends in a vowel or has a median income less than 77000 -->
<!-- ::: -->
