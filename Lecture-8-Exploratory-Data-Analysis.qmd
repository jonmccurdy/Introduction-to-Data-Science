...
<a href="Reading-Guide/L8-Reading-Guide.pdf" download> 📄 Download the lecture's Reading Guide </a>
:::
...
::: {.callout-tip title="Try it Out"}
Help Emmit look at the documentation for the "income_data" dataset in the "MSMU" library and verify that it matches the data available in the package.

<details>

<summary>Click to see the solution</summary>

{{< video https://www.youtube.com/embed/CJGmzn5gNsk?modestbranding=1&rel=0 >}}
...
{{< video https://www.youtube.com/embed/noj9NMF27yA?modestbranding=1&rel=0 >}}
...
{{< video https://www.youtube.com/embed/cbYBvLEbVpY?modestbranding=1&rel=0 >}}
...
{{< video https://www.youtube.com/embed/HARo5cuLL6Y?modestbranding=1&rel=0 >}}
...
{{< video https://www.youtube.com/embed/zLFTSKEm-ak?modestbranding=1&rel=0 >}}
...
{{< video https://www.youtube.com/embed/Vi-MwUnWxa0?modestbranding=1&rel=0 >}}
...
<div class="chapter-resources-header">
  <a href="https://youtu.be/24pKQPb1gqI" target="_blank">Lecture Video</a>
</div>

<div class="chapter-resources-grid">
  <div><a href="Assignments/Data-200-L8-Inclass-Assignment.pdf" target="_blank">In-Class Exercises</a></div>
  <div><a href="https://youtu.be/1KdZiR-arPc" target="_blank">In-Class Exercises Video Solutions</a></div>
</div>

<div class="chapter-resources-footer lab-row">
  <a href="Assignments/Data-200-L8-Lab.pdf" target="_blank">Lab Problems</a>
</div>

<div class="chapter-resources-footer problem-set-row">
  <a href="Assignments/Data-200-L8-Problem-Set.pdf" target="_blank">Problem Set Questions</a>
</div>
...
<!--     d)  Display the unique values of the writing.score column sorted in increasing order. What does the range look like including and excluding missing values? -->
<!--     e)  Explain why it might be important to know how many complete observations exist in this dataset. Use a function to find how many complete rows there are. -->
<!-- ::: -->
