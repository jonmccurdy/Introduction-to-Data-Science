...
<a href="Reading-Guide/L5-Reading-Guide.pdf" download> 📄 Download the lecture's Reading Guide </a>
:::
...
[Error in sample.int(length(x), size, replace, prob) : cannot take a sample larger than the population when 'replace = FALSE']{style="color: red;font-size: 80%; font-family: SFMono-Regular, Consolas, Liberation Mono, Menlo, monospace;"}
...
<div class="chapter-resources-header">
  <a href="https://youtu.be/_yTwoBF75qI" target="_blank">Lecture Video</a>
</div>

<div class="chapter-resources-grid">
  <div><a href="Assignments/Data-200-L5-Inclass-Assignment.pdf" target="_blank">In-Class Exercises</a></div>
  <div><a href="https://youtu.be/u38e_sN-gRU" target="_blank">In-Class Exercises Video Solutions</a></div>
</div>

<div class="chapter-resources-footer lab-row">
  <a href="Assignments/Data-200-L5-Lab.pdf" target="_blank">Lab Problems</a>
</div>

<div class="chapter-resources-footer problem-set-row">
  <a href="Assignments/Data-200-L5-Problem-Set.pdf" target="_blank">Problem Set Questions</a>
</div>
