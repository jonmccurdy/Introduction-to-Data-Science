...
<a href="Reading-Guide/L10-Reading-Guide.pdf" download> 📄 Download the lecture's Reading Guide </a>
:::
...
<div class="chapter-resources-header">
  <a href="https://youtu.be/kU8uS7tHiXc" target="_blank">Lecture Video (Discrete Distributions)</a>
</div>
<div class="chapter-resources-header">
  <a href="https://youtu.be/N_1lrJeO00U" target="_blank">Lecture Video (Continuous Distributions)</a>
</div>

<div class="chapter-resources-grid">
  <div><a href="Assignments/Data-200-L10-Discrete-Inclass-Assignment.pdf" target="_blank">In-Class Exercises (Discrete) </a></div>
  <div><a href="https://youtu.be/pX06vz4aDwg" target="_blank">In-Class Exercises Video Solutions </a></div>
</div>
<div class="chapter-resources-grid">
  <div><a href="Assignments/Data-200-L10-Continuous-Inclass-Assignment.pdf" target="_blank">In-Class Exercises (Continuous) </a></div>
  <div><a href="https://youtu.be/xMmT3f_Qt3s" target="_blank">In-Class Exercises Video Solutions</a></div>
</div>

<div class="chapter-resources-footer lab-row">
  <a href="Assignments/Data-200-L10-Lab.pdf" target="_blank">Lab Problems</a>
</div>

<div class="chapter-resources-footer problem-set-row">
  <a href="Assignments/Data-200-L10-Problem-Set.pdf" target="_blank">Problem Set Questions</a>
</div>
