...
<a href="Reading-Guide/L4-Reading-Guide.pdf" download> 📄 Download the lecture's Reading Guide </a>
:::
...
[Error in "a" + "b" : non-numeric argument to binary operator]{style="color: red;font-size: 80%; font-family: SFMono-Regular, Consolas, Liberation Mono, Menlo, monospace;"}
...
[Error in "abc" + 2 : non-numeric argument to binary operator]{style="color: red;font-size: 80%; font-family: SFMono-Regular, Consolas, Liberation Mono, Menlo, monospace;"}
...
[Warning in Ops.factor(fx\[1\], fx\[2\]) : '\>' not meaningful for factors]{style="color: red;font-size: 80%; font-family: SFMono-Regular, Consolas, Liberation Mono, Menlo, monospace;"}
...
<div class="chapter-resources-header">
  <a href="https://youtu.be/XAFqk2UY_CA" target="_blank">Lecture Video</a>
</div>

<div class="chapter-resources-grid">
  <div><a href="Assignments/Data-200-L4-Inclass-Assignment.pdf" target="_blank">In-Class Exercises</a></div>
  <div><a href="https://youtu.be/Y44S3Y__ZAE" target="_blank">In-Class Exercises Video Solutions</a></div>
</div>

<div class="chapter-resources-footer lab-row">
  <a href="Assignments/Data-200-L4-Lab.pdf" target="_blank">Lab Problems</a>
</div>

<div class="chapter-resources-footer problem-set-row">
  <a href="Assignments/Data-200-L4-Problem-Set.pdf" target="_blank">Problem Set Questions</a>
</div>
